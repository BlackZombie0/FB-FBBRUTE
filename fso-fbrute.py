...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  ======================================="
    print GL+"  ••••••  FSOCIETY-ARAB FACEBOOK.  ••••••"
    print GG+"  ======================================="
    print GL+"            Read in the name of God first"
    print Y+"♦ Created : 4/2020"
    print Y+"♦ Team : FSOCIETY-ARAB"
    print Y+"♦ Github : https://github.com/FSOCIETY-coder-dz"
    print Y+"♦ YouTube : FSOCIETY ARAB"
    print GG+"  ======================================="
    print GG+"   _____   _____   _____   _____   _   _____   _____  __    __"
    print GG+"  |  ___| /  ___/ /  _  \ /  ___| | | | ____| |_   _| \ \  / /" 
    print GG+"  | |__   | |___  | | | | | |     | | | |__     | |    \ \/ /" 
    print GG+"  |  __|  \___  \ | | | | | |     | | |  __|    | |     \  /" 
    print GG+"  | |      ___| | | |_| | | |___  | | | |___    | |     / /" 
    print GG+"  |_|     /_____/ \_____/ \_____| |_| |_____|   |_|    /_/"  
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    os.system('python2 fso-fbrute.py')
                elif g == 'n' or g == 'N':
...
def runn_noobs():
         ...
         lop = GG+"""
             \033[90;1team-FSOCIETY\033[91;1m
             Creator by:\033[97m MOUSSA
      """
